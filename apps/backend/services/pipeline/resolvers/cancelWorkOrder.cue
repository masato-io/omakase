...
cancelWorkOrder : pipeline.#Resolver & {
    ...
    Pipelines: [
        ...
        },
        {
            ...
            //     Expr: """
            //     (() => {
            //         const result = args.removeAllocatedInventoryItem;

            //         if (!result.success) {
            //             return {
            //                 success: false,
            //                 message: 'Failed to remove allocated inventory for item: ' + each.moLineItem.bomLineItem.itemId
            //             };
            //         }
            //         return {
            //             success: true
        ...
        },
        {
            ...
            //     Expr: """
            //     (() => {
            //         const result = args.scrapConsumedInventoryItem;

            //         if (!result.success) {
            //             return {
            //                 success: false,
            //                 message: 'Failed to scrap consumed inventory for item: ' + each.moLineItem.bomLineItem.itemId
            //             };
            //         }
            //         return {
            //             success: true
